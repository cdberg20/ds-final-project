...
$stmt = $db->prepare(
  'UPDATE members SET first_name = ?, last_name = ?, street = ?, city = ?, zip = ?, date_of_birth = ?, start_date = ?, is_active = ?, gender = ?, position = ?, radio_number = ?, station_num = ?, phone = ? WHERE memberID=?'
